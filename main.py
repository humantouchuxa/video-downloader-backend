...
def get_info():
    ...
    # Try multiple strategies — YouTube needs fallbacks
    strategies = [
        {
            'quiet': True,
            'no_warnings': True,
            ...
            'http_headers': {
                'User-Agent': 'Mozilla/5.0 (Linux; Android 12; Quest 2) AppleWebKit/537.36 Chrome/107.0.5304.141 Mobile Safari/537.36',
            }
        },
        {
            'quiet': True,
    ...
    if not info:
        return jsonify({'error': 'Could not fetch video. Try another link.'}), 500
